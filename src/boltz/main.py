...
@click.option(
    "--embedding_interface_steering",
    is_flag=True,
    help="Enable embedding-based interface steering that uses pair embeddings to weight "
         "CDR-antigen distance guidance. Requires --use_potentials. "
