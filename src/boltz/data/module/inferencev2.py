...
class PredictionDataset(torch.utils.data.Dataset):
    ...
    def __getitem__(self, idx: int) -> dict:
        ...
        if options is None:
            pocket_constraints, contact_constraints, cdr3_constraints, antigen_orientation_constraints, asymmetric_beta_constraints = None, None, None, None, None
        else:
            pocket_constraints, contact_constraints, cdr3_constraints, antigen_orientation_constraints, asymmetric_beta_constraints = (
                options.pocket_constraints,
                options.contact_constraints,
                options.cdr3_constraints,
                options.antigen_orientation_constraints,
                options.asymmetric_beta_constraints,
            )
        ...
        try:
            features = self.featurizer.process(
                ...
                inference_asymmetric_beta_constraints=asymmetric_beta_constraints,
