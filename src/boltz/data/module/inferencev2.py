...
class PredictionDataset(torch.utils.data.Dataset):
    ...
    def __getitem__(self, idx: int) -> dict:
        ...
        if options is None:
            pocket_constraints, contact_constraints, cdr3_constraints, antigen_orientation_constraints, cdr3_beta_constraints, embedding_interface_constraints, hybrid_fk_hierarchical_constraints = None, None, None, None, None, None, None
        else:
            pocket_constraints, contact_constraints, cdr3_constraints, antigen_orientation_constraints, cdr3_beta_constraints, embedding_interface_constraints, hybrid_fk_hierarchical_constraints = (
                ...
                options.embedding_interface_constraints,
                options.hybrid_fk_hierarchical_constraints,
            )
        ...
        try:
            features = self.featurizer.process(
                ...
                inference_embedding_interface_constraints=embedding_interface_constraints,
                inference_hybrid_fk_hierarchical_constraints=hybrid_fk_hierarchical_constraints,
